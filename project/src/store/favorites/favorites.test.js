...
describe('Reducer: favorites', () => {
  ...
  it('action get offers should return initial state', () => {
    const offersAction = {
    ...
    expect(favorites(initialState, offersAction)).toEqual({...initialState, favoritesList: groupOffersByCity(adaptDataList(offersAction.payload))});
  });
});
